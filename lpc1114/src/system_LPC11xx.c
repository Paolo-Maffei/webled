...
#define MAIN_CLKSRCSEL_Val    0x00000000           /*select IRC*/
#define MAIN_PLL_M_Val        0x00000003           /* main clock = FCLKOUT = (12M*MAIN_PLL_M_Val+1) = 48M */
#define MAIN_PLL_P_Val        0x00000001           /*P = MAIN_PLL_P_Val *2 */
